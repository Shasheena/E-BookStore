                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo $book_data["title"] ?>" readonly>
                            </div>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                ?>
                                <input type="text" class="form-control" value="<?php echo $category_data["name"] ?>" readonly />
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" value="<?php echo $book_data["seller_seller_mail"] ?>" readonly>
                            </div>
                        </div>
                        <?php
                        if ($book_data["copy_copy_id"] == 1) {
