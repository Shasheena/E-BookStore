        ...
        <div class="d-block">
            <div class="row">
                <div class="col-12 text-start  mt-3 mt-lg-0">
                    <span class="fs-4" style="font-family: Arial;">My shopping Basket</span>
                </div>
            </div>
            <div class="row">
                ...
                <?php
                $cart_rs = Database::search("SELECT * FROM `cart` WHERE `user_email` = '" . $_SESSION["user"]["email"] . "'");
                ...
                ?>
                    <div class="col-12">
                        <div class="row">
                            <div class="col-12">
                                <h2 class="text-center text-secondary">No items in your cart yet</h2>
                            </div>
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-12 text-center">
                                        <a class="btn btn-info fs-1" href="browse.php">Start shopping</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                ?>
                    ...
                    <?php
                    $book_rs = Database::search("SELECT * FROM `cart` INNER JOIN `books` ON
                    books.book_id = cart.book_id INNER JOIN `authors` ON authors.id = books.authors_id WHERE `user_email` = '" . $_SESSION["user"]["email"] . "'");
                                                        ...
                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-4 text-start mt-2">
                                                                                ...
                                                                                <div class="row mt-2">
                                                                                    <div class="col-12">
                                                                                        <div class="row">
                                                                                            <div class="col-7">
                                                                                                <a type="button" class="btn btn-sm border" onclick="addToWishlist1(<?php echo $book_data['book_id'] ?>);"><i class="bi bi-bookmark-heart"></i>Save for later</a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-12 mt-2">
                                                                                        <div class="row">
                                                                                            <div class="col-5">
                                                                                                <button class="btn btn-sm border" style="background-color: orange;" onclick="removeCart(<?php echo $book_data['book_id'] ?>);">Remove</button>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                            ...
                                                            <div class="col-2">
                                                                <div class="number">
                                                                    ...
                                                                    <input type="text" id="num" style="width: 30px;" value="1" />
                                                                    <button class="plus" onclick="plus();">+</button>
                                                                    <button class="btn btn-sm border" onclick="updateQty(<?php echo $book_data['book_id'] ?>);">Update</button>
                                                                </div>
                                                            </div>
                                                            <div class="col-2 text-start" id="price">
                                                                <span><?php echo $book_data["price"] ?></span>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-12 mt-1 text-center">
                                                            <span class="text-danger"><?php echo $book_data["price"] ?></span>
                                                        </div>
                                                        <div class="col-12">
                                                        ...
                                                        <div class="col-12 mt-2 text-center">
                                                            <button class="btn btn-sm border border-dark" onclick="addToWishlist1(<?php echo $book_data['book_id'] ?>);"><i class="bi bi-bookmark-heart"></i>Save for later</button>
                                                        </div>
                                                        <div class="col-12 mt-2 text-center">
                                                            <button class="btn btn-sm border" style="background-color: orange;" onclick="removeCart(<?php echo $book_data['book_id'] ?>);">Remove</button>
                                                        </div>
