                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-12 text-start">
                                    <span class="text-danger fw-bold">Author</span>
                                ...
                                <div class="col-12 text-center mt-2">
                                    <button class="btn btn-primary" style="border-radius: 30px; width:25%;">Search</button>
                                </div>
                                <div class="col-12 mt-2">
                                    <div class="alert alert-success" role="alert">
                                        <h4 class="alert-heading">News Alerts!</h4>
                    ...
                    <div class="row mb-3 d-flex justify-content-between">
                        <div class="col-lg-3 col-12  mt-3 mt-lg-0">
                            <div class="card shadow" style="width: 18rem;">
                                <img src="resources/t1.jpg" class="card-img-top">
                                <div class="card-body">
                                    <a href="#" class="text-dark">Your own perfect medicine.</a>
                                    <p class="card-text">Christy,Martha.M</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-12  mt-3 mt-lg-0 ">
                            <div class="card shadow" style="width: 18rem;">
                                <img src="resources/t2.jpg" class="card-img-top">
                                <div class="card-body">
                                    <a href="#" class="text-dark">The silva mind control method.</a>
                                    <p class="card-text">Silva,Jose</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-12  mt-3 mt-lg-0">
                            <div class="card shadow" style="width: 18rem;">
                                <img src="resources/t3.jpg" class="card-img-top">
                                <div class="card-body">
                                    <a href="#" class="text-dark">One nation under blackmail.</a>
                                    <p class="card-text">Whitney Webb</p>
                        ...
                        <div class="col-lg-3 col-12  mt-3 mt-lg-0">
                            <div class="card shadow" style="width: 18rem;">
                                <img src="resources/t4.jpg" class="card-img-top">
                                <div class="card-body">
                                    <a href="#" class="text-dark">The daughter of time.</a>
                                    <p class="card-text">Josephine Tey</p>
                                </div>
                            </div>
                        </div>
                    </div>
