...
?>
    ...
    <body>
        <div class="container-fluid vh-100">
            <div class="col-12">
                <div class="row">
                    <h1 class="text-center">Purchasing History</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-lg-2 border-end">
                    <div class="row">
                        <div class="col-12 text-center">
                            <a class="text-decoration-none" href="index.php">Home</a><br /><br />
                ...
                <div class="col-12 text-center mt-3">
                    <button class="btn btn-primary btn-sm" onclick="searchUserOrders();">Search ></button>
                </div>
                <div class="col-12">
                    <div class="row">
                        <div class="col-2"></div>
                        <div class="col-10">
                            <table class="table caption-top">
                                ...
                                <tbody id="result">
                                    ...
                                    INNER JOIN `copy` ON `copy`.`copy_id`=`books`.`copy_copy_id` INNER JOIN `publisher` ON `publisher`.`id`=`books`.`publisher_id` WHERE `user_email`='" . $_SESSION["user"]["email"] . "'");
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td><button class="btn btn-link" onclick="showModalUser(<?php echo $order_data['book_id'] ?>);">View details</button></td>
                                            </tr>
                                        <?php
                                        }
                                    } else {
