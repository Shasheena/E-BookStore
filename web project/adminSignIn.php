                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mt-5">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="page" href="adminSignIn.php">Sign In</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="adminJoin.php">Join</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="password" class="form-control" id="pwd" placeholder="Paasword should have at least 6 characters.." value="<?php echo $password ?>">
                                    </div>
                                    <div class=" text-end mt-5">
                                        <button class="btn btn-link" onclick="adminForgotPassword1();">Forgot Password?</button>
                                    </div>
                                    ...
                                    <div class="mb-4 text-center">
                                        <button class="btn btn-outline-info" onclick="adminSignin();">Sign In</button>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="row">
