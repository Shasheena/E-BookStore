    ...
    <div class="container-fluid 100vh">
        ...
        <div class="col-12">
            <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 shadow bg-light mb-3">
                            <div class="input-group mb-3 mt-3">
                                <input type="text" class="form-control" placeholder="search & sort.."  aria-label="Recipient's username" aria-describedby="button-addon2" id="b_search2">
                                <button class="btn btn-outline-secondary bg-dark" type="button" id="button-addon2" onclick="basicSearch2();"><i class="bi bi-search text-light"></i></button>
                            </div><br />
                            <script>
                                document.getElementById("b_search2").onchange = function(){
                                    document.getElementById("sort").style.display = "block";
                                }
                            </script>
                            <div class="mb-3" id="sort" style="display: none;">
                                <input class="form-check-input" type="radio" name="flexRadioDefault" id="phl">
                                <label class="form-check-label" for="phl">
                                   price high
                                </label>&nbsp;&nbsp;
                                <input class="form-check-input" type="radio" name="flexRadioDefault" id="plh">
                                <label class="form-check-label" for="plh">
                                    price low
                                </label><br/>
                        
                                <input class="form-check-input" type="radio" name="flexRadioDefault1" id="h_copy">
                                <label class="form-check-label" for="h_copy">
                                    Hard copy
                                </label>&nbsp;&nbsp;
                                <input class="form-check-input" type="radio" name="flexRadioDefault1" id="s_copy">
                                <label class="form-check-label" for="s_copy">
                                    Soft copy
                                </label>&nbsp;&nbsp;<br/>
                                <button onclick="userSort();" class="btn btn-success">Sort</button>
                            </div>
                        </div>
                        <hr />
                        <?php
                        ...
                        ?>
                            <div class="col-12  mb-2">
                                <button onclick="showMc(<?php echo $main_cdata['id'] ?>);"><?php echo $main_cdata["name"] ?></button>
                                <div class="row text-start mt-3">
                                    <?php
                                    for ($y = 0; $y < $sub_num; $y++) {
                                        $sub_data = $sub_rs->fetch_assoc();
                                    ?>
                                        <button class="btn btn-primary btn-sm mb-3" onclick="showSc(<?php echo $sub_data['id'] ?>);"><?php echo $sub_data["name"] ?></button><br /><br />
                                    <?php
                                    }
                                    ?>
                                </div>
                ...
                <div class="col-12 col-lg-10" id="result">
                    <!-- row1-->
                    <?php
                    ...
                    ?>
                        <div class="row text-start">
                            <label class="text-dark fs-2 text-decoration-none"><?php echo $main_data["name"] ?></label>
                        </div>
