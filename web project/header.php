        ...
        <div class="col-12">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="row">
                        ...
                        <div class="col-1">
                            <button class="btn btn-light text-dark  border-dark mt-3">Help</button>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row py-2">
                ...
                <div class="col-2 text-start">
                    <a class="fs-6 text-dark text-decoration-none">Sell</a>
                </div>
                <div class="col-1 text-start">
                    <a class="fs-6 text-dark text-decoration-none">Help</a>
                </div>
            </div>
            </div>
                    ...
                    <div class="collapse" id="collapseExample">
                        <div class=" col-12">
                            <ul >
                                ...
                                <li><a class="dropdown-item" href="#">Browse collections</a></li>
