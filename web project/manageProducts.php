        ...
        <div class="row" id="return">
            <div class="col-12 text-center">
                <nav class="navbar bg-info">
                    <div class="">
                        <button class="navbar-brand btn btn-primary mx-2" onclick="window.location.reload();">
                            All
                        </button>
                        <?php 
                        $os = Database::search("SELECT * FROM `books` WHERE `qty`=0");
                        $os_num = $os->num_rows;
                        $sold = Database::search("SELECT * FROM `invoice`");
                        $sold_num = $sold->num_rows;
                        ?>
                        <button class="navbar-brand btn btn-light"  onclick="adminShowOS();">
                            Out of Stock(<?php echo $os_num;?>)
                        </button>
                        <button class="navbar-brand btn btn-light" onclick="adminShowSold();">
                            Sold (<?php echo $sold_num?>)
                        </button>
            ...
            <div class="col-12" id="result_table">
            ...
            <div class="col-12 text-end mb-3">
                <button class="btn btn-danger btn-sm" onclick="adminRemoveAllBooks();" id="rmvallbtn">Remove All</button>
            </div>
        </div>
    </div>
