                        ...
                        <div class="col-12 col-lg-5 mx-2 mx-lg-0">
                            ...
                            <div class="row">
                                ...
                                ?>
                                    <div class="col-12 mx-2 mx-lg-0 mt-2">
                                        <label class="form-label">Quantity:&nbsp;</label>
                                        <input type="number" min="1" max="<?php echo $book_data["qty"] ?>" value="1" />
                                    </div>
                                <?php
                                }
                                ?>
                        ...
                        <div class="col-12 col-lg-3 mt-4 mt-lg-0 mx-4 mx-lg-0">
                            ...
                            city.city_id = address.ci_id WHERE `user_email` = '" . $_SESSION["user"]["email"] . "'");
                                ...
                                <div class="card-body text-center">
                                    ...
                                    ?>
                                        <h3 class="card-subtitle mb-2 text-success text-decoration-line-through">Rs.<?php echo $total ?>.00</h3>
                                        <h3 class="card-subtitle mb-2 text-danger" id="amount">Rs.<?php echo $new_total ?>.00</h3>
                                    <?php
                                    } else {
                                    ?>
                                        <h3 class="card-subtitle mb-2 text-success" id="amount">Rs.<?php echo $total ?>.00</h3>
                                    <?php
                                    }
                                    ?>
                                    ...
                                    <button  class="card-link btn btn-success" onclick="buyNow(<?php echo $book_id;?>);">Buy now</button>
