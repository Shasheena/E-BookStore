...
if (empty($email)) {
    ...
    if ($n > 0) {
        echo ("This user already have an account");
    } else {
        $d = new DateTime();
        ...
        Database::iud("INSERT INTO `user`(`email`,`fname`,`lname`,`password`,`joined_date`,`status_id`,`mobile`)
        VALUES ('".$email."','".$fname."','".$lname."','".$password."','".$date."','2','".$mb."')");
