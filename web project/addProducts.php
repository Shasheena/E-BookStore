...
if (isset($_SESSION["admin"]) or $_SESSION["seller"]) {
?>
                            ...
                            <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-6" id="dfc_div">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <input type="number" class="form-control" id="dfc" aria-label="Amount (to the nearest rupee)" value="0">
                                                                    </div>
                                                                    <div class="col-3">
                                                                        <span class="input-group-text">.00</span>
                                                                    </div>
                                                            ...
                                                            <div class="col-6" id="dfo_div">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <input type="number" class="form-control" id="dfo" aria-label="Amount (to the nearest rupee)" value="0">
                                                                    </div>
                                                                    <div class="col-3">
                                                                        <span class="input-group-text">.00</span>
                                                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        ?>
                                            <input type="email" class="form-control" id="seller" placeholder="Enter the seller.." value="<?php echo $_SESSION["seller"]["email"] ?>">
                                        <?php
                                        } else {
                                        ?>
